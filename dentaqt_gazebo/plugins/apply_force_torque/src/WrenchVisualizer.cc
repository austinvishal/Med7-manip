...
/////////////////////////////////////////////////
WrenchVisualizer::WrenchVisualizer() : dataPtr(utils::MakeUniqueImpl<Implementation>())
{
}
    ...
    rendering::MaterialPtr _material)
{
    ...
    {
        ignwarn << "WrenchVisualizer not initialized" << std::endl;
                                          ...
                                          const bool _tip)
{
    ...
    quat.From2Axes(math::Vector3d::UnitZ, _direction);
    if (_tip)
    {
