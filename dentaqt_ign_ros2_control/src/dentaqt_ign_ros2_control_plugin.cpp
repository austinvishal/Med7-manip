...
#include "dentaqt_ign_ros2_control/dentaqt_ign_ros2_control_plugin.hpp"
...
//////////////////////////////////////////////////
std::map<std::string, ignition::gazebo::Entity>
DentaqtIgnitionROS2ControlPluginPrivate::GetEnabledJoints(
  ...
  for (const auto &jointEntity : jointEntities) {
    ...
    case sdf::JointType::FIXED: {
      RCLCPP_INFO(node_->get_logger(),
                  "[dentaqt_ign_ros2_control] Fixed joint [%s] (Entity=%lu)] "
                  "is skipped",
    ...
    case sdf::JointType::UNIVERSAL: {
      RCLCPP_WARN(node_->get_logger(),
                  "[dentaqt_ign_ros2_control] Joint [%s] (Entity=%lu)] is of "
                  "unsupported type."
...
//////////////////////////////////////////////////
std::string DentaqtIgnitionROS2ControlPluginPrivate::getURDF() const {
  ...
  while (urdf_string.empty()) {
    ...
    if (!urdf_string.empty()) {
      ...
      RCLCPP_ERROR(node_->get_logger(),
                   "dentaqt_ign_ros2_control plugin is waiting for model"
...
//////////////////////////////////////////////////
DentaqtIgnitionROS2ControlPlugin::DentaqtIgnitionROS2ControlPlugin()
    : dataPtr(std::make_unique<DentaqtIgnitionROS2ControlPluginPrivate>()) {}
...
//////////////////////////////////////////////////
void DentaqtIgnitionROS2ControlPlugin::Configure(
    const ignition::gazebo::Entity &_entity,
  ...
  try {
    ...
    RCLCPP_ERROR_STREAM(
        this->dataPtr->node_->get_logger(),
        "Error parsing URDF in dentaqt_ign_ros2_control plugin, "
        "plugin not active : "
            << ex.what());
    return;
  }
  ...
  for (unsigned int i = 0; i < control_hardware_info.size(); ++i) {
    ...
    std::unique_ptr<dentaqt_ign_ros2_control::DentaqtIgnitionSystemInterface>
        ignitionSystem;
    ...
    if (!ignitionSystem->initSim(this->dataPtr->node_, enabledJoints,
...
//////////////////////////////////////////////////
void DentaqtIgnitionROS2ControlPlugin::PreUpdate(
...
//////////////////////////////////////////////////
void DentaqtIgnitionROS2ControlPlugin::PostUpdate(
    const ignition::gazebo::UpdateInfo &_info,
  ...
  if (sim_period >= this->dataPtr->control_period_) {
    ...
    auto ign_controller_manager = std::dynamic_pointer_cast<
        dentaqt_ign_ros2_control::DentaqtIgnitionSystemInterface>(
...
IGNITION_ADD_PLUGIN(dentaqt_ign_ros2_control::DentaqtIgnitionROS2ControlPlugin,
                    ignition::gazebo::System,
                    dentaqt_ign_ros2_control::DentaqtIgnitionROS2ControlPlugin::
                        ISystemConfigure,
                    dentaqt_ign_ros2_control::DentaqtIgnitionROS2ControlPlugin::
                        ISystemPreUpdate,
                    dentaqt_ign_ros2_control::DentaqtIgnitionROS2ControlPlugin::
