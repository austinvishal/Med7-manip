...
#ifndef DENTAQT_IGN_ROS2_CONTROL_IGN_SYSTEM_HPP
#define DENTAQT_IGN_ROS2_CONTROL_IGN_SYSTEM_HPP

#include "dentaqt_ign_ros2_control/dentaqt_ign_system_interface.hpp"
...
// Forward declaration
class DentaqtIgnitionSystemPrivate;
...
class DentaqtIgnitionSystem : public DentaqtIgnitionSystemInterface {
public:
...
private:
  ...
  std::unique_ptr<DentaqtIgnitionSystemPrivate> dataPtr;
};

} // namespace dentaqt_ign_ros2_control

#endif // DENTAQT_IGN_ROS2_CONTROL_IGN_SYSTEM_HPP
